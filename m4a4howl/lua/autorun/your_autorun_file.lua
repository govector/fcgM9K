...
//weapon name
sound.Add({
	name = 			"m4a4_howlin_shot",
	channel = 		CHAN_USER_BASE+10, --see how this is a different channel? Gunshots go here
	volume = 		1.0,
	sound = 			"weapons/m4a4_howlin/m4a1-1.wav"
})

sound.Add({
	name = 			"howlin_m4a4.Clipout",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/m4a4_howlin/m4a1_clipout.wav"
})

sound.Add({
	name = 			"howlin_m4a4.Clipin",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/m4a4_howlin/m4a1_clipin.wav"
})

sound.Add({
	name = 			"howlin_m4a4.BoltForward",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/m4a4_howlin/m4a1_boltforward.wav"
})

sound.Add({
	name = 			"howlin_m4a4.BoltBack",
	channel = 		CHAN_ITEM,
	volume = 		1.0,
	sound = 			"weapons/m4a4_howlin/m4a1_boltpull.wav"
})
